...
@Time    : 2022/3/4 18:02
@File    : test_hp_2.py
@Explain : 测试用例-帮助中心-Flash中心使用指南
"""
import allure
import pytest
from PageObjects.page_hp_2 import HpPage_2
...
class TestHp_2:
    ...
    def test_click_hp_1(self,testhp_back):
        ...
        # Flash中心使用指南
        try:
            HpPage_2(testhp_back).click_help_data_2()
        except:
        ...
        try:
            HpPage_2(testhp_back).click_art_1()
        ...
        try:
            HpPage_2(testhp_back).click_art_2()
            CommonPage(testhp_back).close_switch_window()
            CommonPage(testhp_back).switch_window_no_close()
        except:
            logger.exception("当前用例执行失败，点击页面有报错\n")
        ...
        try:
            HpPage_2(testhp_back).click_art_3()
            CommonPage(testhp_back).close_switch_window()
            CommonPage(testhp_back).switch_window_no_close()
        except:
            logger.exception("当前用例执行失败，点击页面有报错\n")
        ...
        try:
            HpPage_2(testhp_back).click_art_4()
            CommonPage(testhp_back).close_switch_window()
            CommonPage(testhp_back).switch_window_no_close()
        except:
            logger.exception("当前用例执行失败，点击页面有报错\n")
        ...
        try:
            HpPage_2(testhp_back).click_art_5()
            CommonPage(testhp_back).close_switch_window()
            CommonPage(testhp_back).switch_window_no_close()
        except:
            logger.exception("当前用例执行失败，点击页面有报错\n")
        ...
        try:
            HpPage_2(testhp_back).click_art_6()
            CommonPage(testhp_back).close_switch_window()
            CommonPage(testhp_back).switch_window_no_close()
        except:
            logger.exception("当前用例执行失败，点击页面有报错\n")
        ...
        try:
            HpPage_2(testhp_back).click_art_7()
            CommonPage(testhp_back).close_switch_window()
            CommonPage(testhp_back).switch_window_no_close()
        except:
            logger.exception("当前用例执行失败，点击页面有报错\n")
